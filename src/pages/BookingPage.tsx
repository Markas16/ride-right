...
import { ArrowLeft, CheckCircle, Calendar, CreditCard, Car, Clock, ArrowRight } from "lucide-react";
            ...
            <CardContent className="flex-1 p-6 flex flex-col justify-center">
              ...
              <div className="flex gap-4 text-sm">
                <span className="flex items-center gap-1.5 text-primary font-semibold">
                  <Clock className="h-4 w-4" /> ₹{vehicle.price_per_hour}/hr
                </span>
                <span className="flex items-center gap-1.5 text-accent font-semibold">
                  <Calendar className="h-4 w-4" /> ₹{vehicle.price_per_day}/day
                </span>
              </div>
            </CardContent>
          </div>
              ...
              <Card className="glass-card rounded-2xl border-border/30">
                <CardContent className="p-10 text-center space-y-5">
                  ...
                  <Button
                    ...
                    className="rounded-xl gradient-primary text-primary-foreground hover:opacity-90 gap-2 px-8"
                  >
            ...
            >
              <Card className="glass-card rounded-2xl border-border/30">
                ...
                <CardContent className="space-y-5">
                  ...
                  <Button
                    className="w-full h-12 rounded-xl gradient-primary text-primary-foreground hover:opacity-90 gap-2 font-semibold"
                    disabled={!pricing}
                    onClick={() => setStep(2)}
                  >
